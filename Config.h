#pragma once
//项目-> 属性-> 链接器-> system-> 堆栈保留大小/堆栈提交大小 100000000
#define Fs					5000
#define DATA_LENGTH			50000
#define DATA_CHANNEL		33
#define CHANNEL_INDEX		16//Fpz：60/64; Fz:16/32
...
// The following tables are based on logical channel positions.
	...
	UCHAR	nResolution[256];	// 0 = 100 nV, 1 = 500 nV, 2 = 10 礦, 3 = 152.6 礦
...
// Example running mode in case of Monitoring / Recording data
#define SAMPLE_RUN_MODE_AMP_EEG					0	// Example runs with BrainAmp DC
													// or BrainAmp MR or BrainAmp MR plus
													// or BrainAmp Standard

#define SAMPLE_RUN_MODE_AMP_EXG_USE_AUX_BOX		1	// Example runs with BrainAmp ExG 16 
													//   + usage of ExG AUX Box
#define SAMPLE_RUN_MODE_AMP_EXG_USE_INPUT_BOX	2	// Example runs with BrainAmp ExG 16 
													//   + usage of ExG Input Box
